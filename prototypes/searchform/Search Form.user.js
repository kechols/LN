...
(function() {
    ...
    function runMain() {
        ...
        $('.searchsection > div')
            ...
            .append('<div style="border:0" class="prefilter moreopts"><label for="pat">legal topics</label><div class="prefilter moreopts pat"><select multiple id="pat"><option>All Practice Areas</option></select></div></div>')
